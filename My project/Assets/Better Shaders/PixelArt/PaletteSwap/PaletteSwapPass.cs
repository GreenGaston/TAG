...
[System.Serializable]
public class PaletteSwapPass : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        var materials = PaletteSwapMaterials.Instance;
        if (materials == null)
        {
        ...
        //---Custom effect here---
        var customEffect = stack.GetComponent<PaletteSwapVariables>();
        // Only process if the effect is active
        if (customEffect.IsActive())
        {
            //write effects here
            var mat= materials.customEffect;
            mat.SetTexture("_ColorPalette", customEffect.colorPalette.value);
            mat.SetInt("_Invert", customEffect.invert.value ? 1 : 0);
