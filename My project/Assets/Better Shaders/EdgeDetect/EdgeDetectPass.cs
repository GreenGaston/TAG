...
public class EdgeDetectPass : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        var materials = EdgeDetectMaterials.Instance;
        if (materials == null)
        {
        ...
        //---Custom effect here---
        var customEffect = stack.GetComponent<EdgeDetectVariables>();
        // Only process if the effect is active
        if (customEffect.IsActive())
        {
            var mat= materials.customEffect;
            mat.SetColor("_BorderColor", customEffect.borderColor.value);
            mat.SetFloat("_ThreshHold", customEffect.ThreshHold.value);
            mat.SetFloat("_DepthThreshHold", customEffect.DepthThreshold.value);
